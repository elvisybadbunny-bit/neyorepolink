...
export async function GET() {
  try {
    ...
    // U.3 — every real export is ALSO a real, centrally-visible compliance
    // event (auto-completed, no review needed for an export itself).
    await fileComplianceRequest(user, { kind: "EXPORT_DATA" });
