  ...
  try {
    ...
    if (action === "save_config") {
      const result = await saveTimetableConfig(user, {
        ...
        assemblyBeforeLessonsLabel: typeof body.assemblyBeforeLessonsLabel === "string" ? body.assemblyBeforeLessonsLabel : null,
        assemblyBeforeLessonsMins: Math.max(0, Math.min(180, Number(body.assemblyBeforeLessonsMins || 0))),
