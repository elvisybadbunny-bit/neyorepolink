...
const ITEMS: SettingItem[] = [
  ...
  { label: "Custom features", description: "Ask NEYO to build something bespoke for your school.", href: "/settings/custom-features", icon: Sparkles, permission: "tenant.manage_settings" },
