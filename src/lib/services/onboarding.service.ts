...
import { generateNeyoLoginId, computeUniqueIdPrefix } from "@/lib/services/identity.service";
...
export async function signupSchool(
  ...
  // T.4 — compute this brand-new school's real, auto-disambiguated ID
  // prefix ONCE, before creation, so it's persisted from the very first
  // real admission/invoice number this school ever generates.
