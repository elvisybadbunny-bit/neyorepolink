...
/**
 * T.1 — build the printable A4 sheet of per-copy library QR labels for a
 * book. Reuses the real, already-generated LibraryBookCopy codes (never
 * mints new ones here) — this function is pure rendering.
 */
