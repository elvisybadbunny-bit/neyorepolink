...
export async function createDemoSchool(
  ...
  // T.4 — even a real demo tenant gets a real, auto-disambiguated idPrefix
  // (its random-suffix slug makes a real collision astronomically unlikely,
  // but the guarantee should be uniform across every real tenant-creation
  // path, not just onboarding).
