...
export const INTEGRATION_CREDENTIALS = [
  ...
  // U.3 (2026-07-09) — "Ask Bundi" (Founder AI), a real internal-only
  // natural-language Q&A layer over NEYO's own live company data (revenue,
  // churn-risk, support queues, module adoption). Same honest gating pattern
