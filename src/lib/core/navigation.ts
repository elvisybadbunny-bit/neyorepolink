...
export const NAVIGATION: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "NEYO Support Console", href: "/neyo-support-console", icon: HeartHandshake, permission: "neyo.customer_requests" },
      { label: "My children", href: "/portal", icon: HeartHandshake, permission: "portal.parent" },
      { label: "Receipts", href: "/portal/receipts", icon: Receipt, permission: "portal.parent" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Grading Engine", href: "/academics?tab=grading", icon: Calculator, moduleKey: "academics", permission: "academics.view" },
      ...
      { label: "Pathway Guide", href: "/pathway-guide", icon: Compass },
