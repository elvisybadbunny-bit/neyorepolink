...
interface Student {
  ...
  isRepeating?: boolean; repeatingSinceYear?: number | null;
        ...
        <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center">
          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {s.isRepeating && (
                <Badge tone="amber">
                  <Repeat2 className="h-3 w-3" /> Repeating{s.repeatingSinceYear ? ` since ${s.repeatingSinceYear}` : ""}
                </Badge>
              )}
            </div>
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Vaulting Dialog */}
        {vaulting && (
          <div className="fixed inset-0 z-[60] flex items-end justify-center overflow-hidden bg-navy-950/50 p-0 backdrop-blur-sm sm:items-center sm:p-4" onClick={() => setVaulting(false)}>
        ...
        {/* Handover Dialog */}
        {handingOver && (
          <div className="fixed inset-0 z-[60] flex items-end justify-center overflow-hidden bg-navy-950/50 p-0 backdrop-blur-sm sm:items-center sm:p-4" onClick={() => setHandingOver(false)}>
            <div className="max-h-[calc(100dvh-0.5rem)] w-full max-w-sm overflow-y-auto overscroll-contain rounded-t-3xl border border-navy-200 bg-white p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-card dark:border-navy-700 dark:bg-navy-900 sm:max-h-[90dvh] sm:rounded-2xl sm:p-6" onClick={(e) => e.stopPropagation()}>
              <div className="mb-4 flex items-start justify-between">
