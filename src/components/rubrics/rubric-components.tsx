...
export function RubricForm({ initial, onSubmit, onClose, saving }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center overflow-hidden p-0 sm:items-center sm:p-6">
      ...
      <Card className="relative z-10 max-h-[calc(100dvh-0.5rem)] w-full max-w-3xl overflow-hidden rounded-t-3xl border-navy-200 bg-white pb-[env(safe-area-inset-bottom)] shadow-2xl dark:border-navy-700 dark:bg-navy-900 sm:max-h-[90dvh] sm:rounded-2xl">
