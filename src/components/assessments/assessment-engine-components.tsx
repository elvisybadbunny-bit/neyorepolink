...
export interface AssessmentBoardView {
  ...
  setup: { classes: { id: string; name: string }[]; subjects: { id: string; name: string; code: string; learningAreaId: string | null; learningAreaName: string | null }[]; teachingLinks: { classId: string; subjectId: string }[] };
...
export function AssessmentPlanForm({ types, setup, initial, saving = false, onSubmit, onCancel }: { types: AssessmentTypeView[]; setup: AssessmentBoardView["setup"]; initial?: Partial<AssessmentPlanDraft>; saving?: boolean; onSubmit: (draft: AssessmentPlanDraft) => void; onCancel?: () => void }) {
