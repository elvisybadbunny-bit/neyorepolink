...
function CurriculumModal({ title, icon: Icon, children, onClose }: { title: string; icon: typeof Compass; children: React.ReactNode; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center overflow-hidden bg-navy-950/50 p-0 backdrop-blur-md sm:items-center sm:p-4">
      <Card className="max-h-[calc(100dvh-0.5rem)] w-full max-w-2xl overflow-hidden rounded-t-3xl border-navy-200 bg-white pb-[env(safe-area-inset-bottom)] shadow-2xl dark:border-navy-700 dark:bg-navy-900 sm:max-h-[90dvh] sm:rounded-2xl">
