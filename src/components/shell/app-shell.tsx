  ...
  return (
    <div className="min-h-screen bg-warm-100 dark:bg-navy-950">
      ...
      <div className="flex">
        ...
        <aside className="print:hidden sticky top-14 hidden h-[calc(100vh-3.5rem)] w-60 shrink-0 overflow-y-auto border-r border-navy-200/70 bg-warm-50 shadow-[6px_0_24px_-18px_rgba(28,39,64,0.35)] dark:border-navy-800 dark:bg-navy-900/60 lg:block">
