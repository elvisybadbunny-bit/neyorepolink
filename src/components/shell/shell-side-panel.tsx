...
export function ShellSidePanel() {
  return (
    <aside className="print:hidden sticky top-14 hidden h-[calc(100vh-3.5rem)] w-72 shrink-0 flex-col border-r border-navy-200/70 bg-warm-50 shadow-[6px_0_24px_-18px_rgba(28,39,64,0.35)] dark:border-navy-800 dark:bg-navy-900/60 lg:flex">
      <div className="flex min-h-0 flex-1 flex-col">
        <ActivitySection />
      </div>
