 ...
 *
 * Z.3 — never renders on `/print/*` routes: those are real, dedicated
 * print-only pages (no app chrome by design), and a floating banner would
 * otherwise overlay real printed timetable content in both the on-screen
 * preview and any PDF export.
 */
