...
import { CustomFeatureRequestsOpsTab } from "@/components/founder/custom-feature-requests-ops-tab";
import { PathwayGuideOpsTab } from "@/components/founder/pathway-guide-ops-tab";
import { DiscountCampaignsOpsTab } from "@/components/founder/discount-campaigns-ops-tab";
import { InfluencerCodesOpsTab } from "@/components/founder/influencer-codes-ops-tab";
...
import { ExamSharingApprovalTab } from "@/components/founder/exam-sharing-approval-tab";
...
export function FounderOpsClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "Exam Sharing Approval" && <ExamSharingApprovalTab />}
