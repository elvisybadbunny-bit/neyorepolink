...
export function NeyoWayOpsTab() {
  ...
  return <div className="space-y-6">
    ...
    <Card><CardHeader><CardTitle className="text-base">Founder guardrails</CardTitle></CardHeader><CardContent className="grid gap-3 md:grid-cols-3"><Guard icon={ShieldCheck} title="Do not claim what is unproven" text="No live-school, compliance, credential, payment or reliability claim without evidence."/><Guard icon={Target} title="Three active priorities" text="One reliability priority, one school-value priority and one revenue priority at a time."/><Guard icon={AlertTriangle} title="Protect founder capacity" text="University, sleep and health are constraints. Document emergency access and build an advisor circle."/></CardContent></Card>

    <Card><CardHeader><CardTitle className="flex items-center gap-2 text-base"><Plus className="h-4 w-4"/>Add a company action</CardTitle></CardHeader><CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
