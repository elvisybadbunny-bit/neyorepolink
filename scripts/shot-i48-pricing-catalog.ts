...
const OUT = "screenshots/i48-pricing-catalog.png";
async function main() {
  ...
  await page.waitForSelector("text=Pricing & Package Editor", { timeout: 20000 });
  await page.locator("text=Pricing & Package Editor").scrollIntoViewIfNeeded();
