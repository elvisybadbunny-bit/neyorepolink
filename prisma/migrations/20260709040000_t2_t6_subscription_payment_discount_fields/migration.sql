...
INSERT INTO "new_SubscriptionPayment" ("accountRef", "amount", "checkoutRequestId", "createdAt", "id", "method", "mpesaRef", "paidAt", "periodEnd", "periodStart", "phone", "rawCallback", "referralDiscountKes", "resultCode", "resultDesc", "status", "subscriptionId", "tenantId") SELECT "accountRef", "amount", "checkoutRequestId", "createdAt", "id", "method", "mpesaRef", "paidAt", "periodEnd", "periodStart", "phone", "rawCallback", "referralDiscountKes", "resultCode", "resultDesc", "status", "subscriptionId", "tenantId" FROM "SubscriptionPayment";
