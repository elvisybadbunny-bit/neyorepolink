...
INSERT INTO "new_Student" ("admissionNo", "admittedOn", "birthCertNo", "boardingType", "classId", "createdAt", "dateOfBirth", "deletedAt", "deletedById", "finalClassLabel", "firstName", "gender", "graduationYear", "id", "lastName", "legacyAdmissionNo", "middleName", "notes", "photoUrl", "status", "tenantId", "updatedAt", "upiNumber", "userId") SELECT "admissionNo", "admittedOn", "birthCertNo", "boardingType", "classId", "createdAt", "dateOfBirth", "deletedAt", "deletedById", "finalClassLabel", "firstName", "gender", "graduationYear", "id", "lastName", "legacyAdmissionNo", "middleName", "notes", "photoUrl", "status", "tenantId", "updatedAt", "upiNumber", "userId" FROM "Student";
DROP TABLE "Student";
